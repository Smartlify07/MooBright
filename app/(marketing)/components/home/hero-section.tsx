...
const HeroSection = () => {
  return (
    <section className="relative h-115.25 w-full px-5 py-10 text-primary-foreground lg:h-full lg:px-10 lg:pt-10 lg:pb-30">
      <div className="bg-1 absolute top-0 left-0 -z-1 h-full w-full"></div>

      <div className="bg-2 absolute top-0 left-0 -z-1 h-full w-full"></div>

      <div className="bg-3 absolute top-0 left-0 -z-1 h-full w-full"></div>

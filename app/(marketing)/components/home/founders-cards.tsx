...
const team = [
  {
    ...
    mobileImageURL: "/home/moses-small.png",
    alt: "moses-oladele",
    description:
  ...
  },
  {
    ...
    mobileImageURL: "/home/ezekiel-small.png",
    description:
  ...
  },
  {
    ...
    mobileImageURL: "/home/obinna-small.png",
    description:
  ...
  },
  {
    ...
    mobileImageURL: "/home/goodluck-small.png",
    description:
    ...
    >
      <div className="relative z-1 h-120 w-103.5 max-w-103.5 lg:h-203.5 lg:w-[526px] lg:max-w-[526px] lg:min-w-[526px]">
        ...
        <Image
          ...
          src={mobileImageURL}
          alt={alt}
          className="top-0 left-0 z-1 h-203.5 w-full object-cover lg:hidden"
        />
        <Image
          width={300}
          height={300}
          src={bigCircleURL}
          className="absolute top-10 left-24 -z-1 hidden size-75 shrink-0 lg:inline"
...
const TeamCards = () => {
  return (
    <div className="team-grid lg:gap-4">
      {team.map((t, i) => (
        <TeamCard {...t} key={i} />
      ))}
    </div>
